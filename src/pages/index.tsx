        ...
        >
          ...
          <Row>
            <div>
              ...
              <Text
                style={{ fontFamily: 'Arial', fontSize: '1em' }}
                strong={true}
              >
                Previously, we developed an algorithm, deTS (R package) to
                decode tissue specificity and built the Tissue-Specific
                Enrichment Analysis DataBase (TSEA-DB). In this work, we
                leveraged the fast-growing single-cell transcriptome profiling
                for human tissues generated by multiple international
                consortiums (e.g. Human Cell Landscape, The Human Lung Cell
                Atlas) and literature resources to conduct the cell
        ...
        <Col xs={5} sm={5} md={5} lg={7} xl={7} push={4}>
          ...
          >
            <Card.Grid style={{ width: '50%', textAlign: 'center' }}>
              <Statistic
                title={<strong style={{ color: '#363636' }}>Sources</strong>}
                value={3}
