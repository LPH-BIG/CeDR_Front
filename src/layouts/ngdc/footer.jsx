  ...
  return (
    <div>
      <Row justify={'center'}>
        ...
        <Col md={4}>
          ...
          <ul style={{ listStyle: 'none', margin: '0', padding: '0' }}>
            ...
            <li>
              <a href="https://ngdc.cncb.ac.cn/ewas" target="_blank">
                EWAS Atlas
              </a>
            </li>
            <li>
            ...
            <li>
              <a
                href="https://ngdc.cncb.ac.cn/gvm"
                target="_blank"
            ...
            <li>
              <a href="https://ngdc.cncb.ac.cn/idog" target="_blank">
                iDog
              </a>
            </li>
            <li>
      ...
      <Row justify={'center'}>
        <Col md={12}>
          <Text>
            © 2021 National Genomics Data Center,
            <span>
